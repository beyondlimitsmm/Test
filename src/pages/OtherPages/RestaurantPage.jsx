            ...
            <div className="p-8 xl:p-0 flex-1 xl:max-w-2xl flex flex-col gap-8">
              ...
              <div className="flex-col flex gap-4">
                <p className="leading-relaxed typo-body-2 transition-all duration-500">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Fugiat molestiae impedit, nobis eligendi nam saepe! Dolorum
                  autem consequuntur natus fuga veritatis quaerat, aliquid quasi
                  magni quod laudantium nemo omnis aspernatur, veniam non
                  officia porro, animi amet officiis re Lorem ipsum dolor sit,
                  amet consectetur adipisicing elit. Nostrum rerum aliquam,
                  dolores quas harum modi similique quos tempora iusto cum?
                </p>
                <p className="leading-relaxed typo-body-2 transition-all duration-500">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Fugiat molestiae impedit, nobis eligendi nam saepe! Dolorum
                  autem consequuntur natus fugaelit. Officiis pariatur
                  temporibus eum porro nam sed consectetur quia facilis nemo, in
                  architecto enim libero voluptates. Lorem ipsum dolor sit, amet
                  consectetur adipisicing elit. Nostrum rerum aliquam, dolores
                  quas harum modi similique quos tempora iusto cum?
                </p>
                <p className="leading-relaxed typo-body-2 transition-all duration-500">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Fugiat molestiae impedit, nobis eligendi nam saepe! Dolorum
                  autem consequuntur natus fuga veritatis quaerat, aliquid quasi
                  magni quod laudantium nemo omnis quia facilis nemo, in
                  architecto enim libero voluptates. Lorem ipsum dolor sit, amet
                  consectetur adipisicing elit. Nostrum rerum aliquam, dolores
                  quas harum modi similique quos tempora iusto cum?
                </p>
