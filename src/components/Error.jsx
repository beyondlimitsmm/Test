...
const links = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/TheBoundaryResidence",
    description: "Follow on our Facebook page for the latest news",
    icon: (props) => (
      <svg
  ...
  return (
    <div className="bg-white font-Jost w-screen h-screen fixed top-0 left-0 flex justify-center items-center">
      <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
        <img
          className="mx-auto h-full w-32 sm:w-60"
          src={Logo}
          alt="Your Company"
        />
        <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
          ...
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-6 sm:text-lg sm:leading-8">
            Sorry, we couldn’t fetch the data you’re looking for.
          </p>
        </div>
      </main>
